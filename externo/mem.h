...
{
	WriteProcessMemory(pGlobals.hProcess, (PVOID)addressToWrite, &valToWrite, sizeof(dataType), 0);
}
...
template<typename T> T RPM(SIZE_T address) {
	...
	ReadProcessMemory(pGlobals.hProcess, (LPCVOID)address, &buffer, sizeof(T), NULL);
